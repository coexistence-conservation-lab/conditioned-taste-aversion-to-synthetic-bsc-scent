...
# Fit the model with glm
mod <- glm(fox_visits ~ treatment + dist_bou + dist_roads + dist_con + 
              dist_veg + dist_pond + dist_wcl, 
            data = data_mod, family=binomial, na.action = "na.fail")
...
# Since dist_pond and dist_wcl was non-significant, remove from model
mod <- glm(fox_visits ~ treatment + dist_bou + dist_roads + dist_con + dist_veg, 
            data = data_mod, family=binomial, na.action = "na.fail")
...
# Fit the model with glm
mod <- glm(raven_visits ~ treatment + dist_bou + dist_roads + dist_con + 
              dist_veg + dist_pond + dist_wcl, 
            data = data_mod, family=binomial, na.action = "na.fail")
...
# Since dist_pond and dist_wcl was non-significant, remove from model
mod <- glm(raven_visits ~ treatment + dist_bou + dist_roads + dist_con + dist_veg, 
            data = data_mod, family=binomial, na.action = "na.fail")
